...
str2dataset = {"bert": BertDataset, "lm": LmDataset, "mlm": MlmDataset,
               ...
               "cls": ClsDataset, "prefixlm": PrefixlmDataset, "cls_mlm": ClsMlmDataset, "cls_mlm_ner_decode": ClsMlmNerDecodeDataset,
...
str2dataloader = {"bert": BertDataloader, "lm": LmDataloader, "mlm": MlmDataloader,
                  ...
                  "cls": ClsDataloader, "prefixlm": PrefixlmDataloader, "cls_mlm": ClsMlmDataloader, "cls_mlm_ner_decode": ClsMlmNerDecodeDataloader,
...
__all__ = ["CharTokenizer", "SpaceTokenizer", "BertTokenizer", "BPETokenizer", "XLMRobertaTokenizer",
           ...
           "BartDataset", "ClsDataset", "PrefixlmDataset", "ClsMlmDataset", "ClsMlmNerDecodeDataset",
           ...
           "BartDataloader", "ClsDataloader", "PrefixlmDataloader", "ClsMlmDataloader", "ClsMlmNerDecodeDataloader",
