...
str2dataset = {"bert": BertDataset, "lm": LmDataset, "mlm": MlmDataset,
               ...
               "cls": ClsDataset, "prefixlm": PrefixlmDataset, "cls_mlm": ClsMlmDataset, "cls_mlm_ner": ClsMlmNerDataset,"cls_mlm_ner_lm": ClsMlmNerLmDataset,
...
str2dataloader = {"bert": BertDataloader, "lm": LmDataloader, "mlm": MlmDataloader,
                  ...
                  "cls": ClsDataloader, "prefixlm": PrefixlmDataloader, "cls_mlm": ClsMlmDataloader, "cls_mlm_ner": ClsMlmNerDataloader,"cls_mlm_ner_lm": ClsMlmNerLmDataloader,
...
__all__ = ["CharTokenizer", "SpaceTokenizer", "BertTokenizer", "BPETokenizer", "XLMRobertaTokenizer",
           ...
           "BartDataset", "ClsDataset", "PrefixlmDataset", "ClsMlmDataset", "ClsMlmNerDataset",
           ...
           "BartDataloader", "ClsDataloader", "PrefixlmDataloader", "ClsMlmDataloader", "ClsMlmNerDataloader",
