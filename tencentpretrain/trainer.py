...
class ClsMlmNerDecodeTrainer(Trainer):
    def __init__(self, args):
        super(ClsMlmNerDecodeTrainer, self).__init__(args)
        self.total_loss_cls = 0.0
        self.total_correct_cls = 0.0
    ...
    def forward_propagation(self, batch, model):
        ...
        tgt = {"mlm": tgt_mlm, "cls": tgt_cls, "ner": tgt_ner, "decode": tgt_lm}
        loss_info = model(src, tgt, seg)
        loss_mlm, correct_mlm, denominator = loss_info["mlm"]
        loss_cls, correct_cls = loss_info["cls"]
        loss_ner, correct_ner,denominator_ner = loss_info["ner"]
        loss_lm, correct_lm, denominator_lm = loss_info["decode"]
...
str2trainer = {"bert": BertTrainer, "mlm": MlmTrainer, "lm": LmTrainer,
               ...
               "bart": BartTrainer, "prefixlm": PrefixlmTrainer, "cls_mlm": ClsMlmTrainer, "cls_mlm_ner_decode": ClsMlmNerDecodeTrainer,
