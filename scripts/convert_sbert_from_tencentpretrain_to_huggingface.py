...
def convert_sbert_transformer_encoder_from_tencentpretrain_to_huggingface(input_model, output_model, layers_num):
...
def main():
    ...
    convert_sbert_transformer_encoder_from_tencentpretrain_to_huggingface(input_model, output_model, args.layers_num)
